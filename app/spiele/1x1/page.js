...
export default function EinmalEinsSite() {
  ...
  // Generate questions only on client mount
  useEffect(() => {
  ...
  // Guard for initial render before questions are generated
    ...
    <Box sx={{ minHeight: '100vh', bgcolor: '#fdfdfd' }}>
      ...
      <Container maxWidth="sm" sx={{ mt: 4, textAlign: 'center', pb: 10 }}>
        ...
        <EndMenuNextGame
          ...
          winAnswer={`Du hast ${time} Sekunden gebraucht.`}
          nextGameLink="/spiele"
          backLink="/spiele"
        />
      </Container>
